...
- Recorded fact, user assertion, inference and synthetic reconstruction must remain distinguishable.
- Minors/shared memories/face or voice recreation require explicit consent rules.
- Story output cannot fabricate biography as fact.
