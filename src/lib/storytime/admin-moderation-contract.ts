...
export type StorytimeModerationDecision = "approve" | "reject" | "escalate" | "request_user_revision";
...
export function assertStorytimeModerationDecisionReceipt(
  receipt: StorytimeModerationDecisionReceipt
) {
  ...
  if (receipt.containsRawStoryContent !== false) {
    throw new Error("Storytime moderation decision receipts must not contain raw story content.");
  }
